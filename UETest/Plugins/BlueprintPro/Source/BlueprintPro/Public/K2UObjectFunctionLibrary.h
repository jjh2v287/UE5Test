 ...
 */
UCLASS()
class BLUEPRINTPRO_API UK2UObjectFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	/** Set UObject single property value by name */
	UFUNCTION(BlueprintCallable, CustomThunk, meta = (BlueprintInternalUseOnly = "true", CustomStructureParam = "Value", AutoCreateRefTerm = "Value"), Category = "BlueprintPro|Object")
...
public: // Get Property Value
	...
	UFUNCTION(BlueprintCallable, CustomThunk, meta = (BlueprintInternalUseOnly = "true", ArrayParm = "Value", ArrayTypeDependentParams = "Value"), Category = "BlueprintPro|Object")
	...
	UFUNCTION(BlueprintCallable, CustomThunk, meta = (BlueprintInternalUseOnly = "true", MapParam = "Value"), Category = "BlueprintPro|Object")
	...
	UFUNCTION(BlueprintCallable, CustomThunk, meta = (BlueprintInternalUseOnly = "true", SetParam = "Value"), Category = "BlueprintPro|Object")
