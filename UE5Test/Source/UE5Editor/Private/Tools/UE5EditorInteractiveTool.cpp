...
#include "UE5EditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUE5EditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUE5EditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUE5EditorInteractiveTool* NewTool = NewObject<UUE5EditorInteractiveTool>(SceneState.ToolManager);
...
UUE5EditorInteractiveToolProperties::UUE5EditorInteractiveToolProperties()
{
...
void UUE5EditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUE5EditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUE5EditorInteractiveToolProperties>(this, "Measurement");
...
void UUE5EditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUE5EditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUE5EditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUE5EditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUE5EditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUE5EditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUE5EditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUE5EditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUE5EditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
