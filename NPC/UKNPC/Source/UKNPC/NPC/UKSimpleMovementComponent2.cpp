...
#include "UKSimpleMovementComponent2.h"
...
UUKSimpleMovementComponent2::UUKSimpleMovementComponent2()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UUKSimpleMovementComponent2::BeginPlay()
{
	Super::BeginPlay();
...
// 1. AI의 이동 요청 수신
void UUKSimpleMovementComponent2::RequestDirectMove(const FVector& MoveVelocity, bool bForceMaxSpeed)
{
...
// 2. 매 프레임 이동 처리
void UUKSimpleMovementComponent2::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
void UUKSimpleMovementComponent2::GravityTick(float DeltaTime)
{
...
void UUKSimpleMovementComponent2::SimpleWalkingUpdate(float DeltaTime)
{
...
bool UUKSimpleMovementComponent2::CheckWalkable(const FVector& FloorNormal) const
{
...
bool UUKSimpleMovementComponent2::FindGround(const FVector& QueryOrigin, FHitResult& OutHit, const float DeltaTime) const
{
