...
#include "UE5EditorInteractiveTool.generated.h"


/**
 * Builder for UUE5EditorInteractiveTool
 */
UCLASS()
class UE5EDITOR_API UUE5EditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UUE5EditorInteractiveTool
 */
UCLASS(Transient)
class UE5EDITOR_API UUE5EditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UUE5EditorInteractiveToolProperties();
...
/**
 * UUE5EditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class UE5EDITOR_API UUE5EditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UUE5EditorInteractiveToolProperties> Properties;
