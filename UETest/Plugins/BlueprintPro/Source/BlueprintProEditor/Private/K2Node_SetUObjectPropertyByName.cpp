...
{
	return LOCTEXT("NodeCategory", "BlueprintPro");
}


FText UK2Node_SetUObjectPropertyByName::GetKeywords() const
{
	return LOCTEXT("NodeKeywords", "set,Object,Property,value,Wildcard,k2node");
}
