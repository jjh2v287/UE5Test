...
#include "UE5EditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UUE5EditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_UE5EditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UUE5EditorEditorMode();
	virtual ~UUE5EditorEditorMode();
