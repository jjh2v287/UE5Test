...
#include "UKSimpleMovementComponent2.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class UKNPC_API UUKSimpleMovementComponent2 : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UUKSimpleMovementComponent2();
